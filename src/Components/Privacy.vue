	...
	<div class="container text-center mb-2">
		<div class="row justify-content-xxl-center">
			<div class="col text-start">
				<label class="fw-bold fs-4">Privacy policy</label>
				<hr />
			</div>
		</div>
		<div class="row justify-content-xxl-center">
			<div class="col text-start">
				...
				<ul>
					...
					<li>
						<p>
							...
							Agreement) refers to Konrad Łowczak Solutions.
						</p>
					</li>
					<li>
						<p>
					...
					<li>
						<p>
							<strong>Website</strong> refers to minesweeper-free.com, accessible from
							<a href="https://minesweeper-free.com" rel="external nofollow noopener" target="_blank"
								>https://minesweeper-free.com</a
							>
						</p>
					</li>
					<li>
				...
				<ul>
					<li>
						<p>By email: contact@minesweeper-free.com</p>
					</li>
				</ul>
			</div>
		</div>
